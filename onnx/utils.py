...
def infer_args():
    ...
    parser.add_argument(
        "--rec_char_dict_path",
        type=str,
        default='./onnx/models/ch_ppocr_server_v2.0/ppocr_keys_v1.txt')
    parser.add_argument("--use_space_char", type=str2bool, default=True)
    parser.add_argument(
        "--vis_font_path", type=str, default="./onnx/fonts/simfang.ttf")
    ...
    parser.add_argument("--cls_model_dir", type=str, default='./onnx/models/ch_ppocr_server_v2.0/cls/cls.onnx')
